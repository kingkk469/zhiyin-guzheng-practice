...
import { alignReviewScore } from "./review-score.mjs";
import {
...
self.onmessage = async ({ data }) => {
  ...
  try {
    ...
    self.postMessage({
      type: "done",
      engine: "Zhiyin pluck recognition 0.9.0",
      baselineEngine: "Spotify Basic Pitch 1.0.1",
      ...notes,
      residual: alignReviewScore(reviewResidual(samples), data.referenceScore),
      referenceScore: data.referenceScore ?? null,
